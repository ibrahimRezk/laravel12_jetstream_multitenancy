...
<template>
    <div>
        <div
            class="p-6 lg:p-8 bg-white dark:bg-zinc-800 dark:bg-linear-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700"
        >
        ...
        <div
            class="bg-zinc-200 dark:bg-zinc-800 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8"
        >
            <div>
